...
export function CoffeeMicroStep() {
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-xl font-semibold text-foreground mb-2">
          Micronutrientes — Café {coffeeLabel}
        </h2>
      ...
      <div className="p-4 bg-secondary rounded-xl mt-6">
        <p className="text-xs text-muted-foreground">
          <span className="text-foreground font-medium">Opcional:</span> Esses valores ajudam a gerar recomendações de micronutrientes mais precisas para o café.
        </p>
      </div>
    </div>
  );
